  ...
  ja: {
    ...
    tabs: {
      ...
      kitten: {
        ...
        description:
          "実際に生まれた子猫たちの色柄を入力して、次回以降の予測をより現実に近づけます。",
      },
    },
    common: {
      breed: "猫種 (任意)",
    ...
    targetForm: {
      registrationTitle: "候補猫の色柄登録",
      name: "登録名",
      namePlaceholder: "例: 青系の母猫候補",
      coat: "色柄",
      coatPlaceholder: "例: Blue / Chocolate",
      addCoat: "＋ 色柄追加",
      additionalCoat: "追加色柄",
      breedPlaceholder: "例: British Shorthair",
      carriers: "確認済み因子 (任意)",
      ...
      savedTitle: "登録した候補",
      savedEmpty:
        "父猫候補・母猫候補の色柄を追加すると、目標色柄に合う組み合わせを探せます。",
      sireGroup: "父猫候補",
      damGroup: "母猫候補",
      emptyGroup: "まだ登録されていません。",
      targetTitle: "目標色柄の選択",
      targetCoat: "目標色柄",
      targetPlaceholder: "例: Lilac / Cinnamon Golden Tabby",
      targetSex: "子猫の性別 (任意)",
      loading: "検索中…",
      button: "候補を探す",
      ranking: "結果ランキング",
    ...
    kittenForm: {
      sectionTitle: "親猫と子猫の色柄",
      sireCoat: "父猫の色柄",
      damCoat: "母猫の色柄",
      sirePlaceholder: "例: Blue",
      damPlaceholder: "例: Red Tabby",
      breedPlaceholder: "例: British Shorthair",
      kittenSection: "子猫の色柄",
      addKitten: "＋ 子猫を追加",
      kittenName: "子猫名",
      ...
      kittenCoat: "子猫の色柄",
      kittenCoatPlaceholder: "例: Blue Patched Tabby",
      loading: "見直し中…",
      button: "予測を見直す",
      resultTitle: "見直し結果",
      candidateCount: "候補",
  ...
  en: {
    ...
    tabs: {
      ...
      kitten: {
        ...
        description: "Use real kitten coat outcomes to improve future estimates.",
      },
    },
    common: {
    ...
    targetForm: {
      registrationTitle: "Coat candidate registry",
      name: "Name",
      namePlaceholder: "e.g. Blue dam candidate",
      coat: "Coat",
      ...
      savedTitle: "Saved candidates",
      savedEmpty:
        "Add sire and dam coat candidates to find combinations for the target coat.",
      sireGroup: "Sire candidates",
      damGroup: "Dam candidates",
      emptyGroup: "No candidates registered yet.",
    ...
    kittenForm: {
      sectionTitle: "Parent and kitten coats",
      sireCoat: "Sire coat",
      damCoat: "Dam coat",
      sirePlaceholder: "e.g. Blue",
      damPlaceholder: "e.g. Red Tabby",
      breedPlaceholder: "e.g. British Shorthair",
      kittenSection: "Kitten coats",
      ...
      loading: "Refining...",
      button: "Refine Forecast",
      resultTitle: "Refined forecast",
