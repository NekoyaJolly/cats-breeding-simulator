...
export const UI_TEXT = {
  ja: {
    ...
    parentResult: {
      ...
      aocAria: "AOC の説明を開く",
      normalScopeTitle: "通常モードについて",
      normalScopeSummary: "親の毛色から確定できる範囲だけを表示しています",
      normalScopeMore: "詳しく",
      normalScopeDetails:
        "隠れた劣性キャリア（例: タビーの親が内在し得るソリッド遺伝子）は仮定していません。そのため、理論上は生まれ得ても親の毛色からは確定できない毛色は表示していません。こうした毛色も確認したい場合は、計算モードを「明示キャリア」に切り替えて、確認済みのキャリアを指定してください。",
    },
    targetForm: {
    ...
    kittenForm: {
      ...
      kittenCoat: "子猫の色柄",
      kittenCoatPlaceholder: "例: Blue Tabby / ブルータビー",
      loading: "推定中…",
      button: "隠れキャリアを推定する",
      resultTitle: "推定結果",
      candidateCount: "候補",
  ...
  en: {
    ...
    parentResult: {
      ...
      conditionalTitle: "If these colors appear",
      conditionalHint:
      ...
      normalScopeTitle: "About normal mode",
      normalScopeSummary: "Showing only what can be confirmed from the parents' coats",
      normalScopeMore: "Details",
      normalScopeDetails:
        "Hidden recessive carriers (for example, the solid gene a tabby parent may carry) are not assumed. Colors that are biologically possible but cannot be confirmed from the parents' coats are therefore not shown. To explore those, switch the calculation mode to 'Explicit carriers' and specify the confirmed carriers.",
    },
    targetForm: {
