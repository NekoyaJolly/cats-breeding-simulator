...
const inputClass =
  "h-11 w-full rounded-md border border-line bg-surface py-2 text-base leading-6 shadow-sm transition focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent/40 sm:text-sm sm:leading-5";
